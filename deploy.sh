...
docker push sturs23/complex-k8s-worker:latest sturs23/complex-k8s-worker:$GIT_SHA
docker push sturs23/complex-k8s-server:latest sturs23/complex-k8s-server:$GIT_SHA
docker push sturs23/complex-k8s-client:latest sturs23/complex-k8s-client:$GIT_SHA
kubectl apply -f ./k8s
